...
\usepackage{./latex/template-esalq}
$if(fontfamily)$
...
$if(esalq-dedication)$
  \input{$esalq-dedication$}
  \clearpage
$endif$
$if(esalq-acknowledge)$
  \input{$esalq-acknowledge$}
  \clearpage
$endif$
$if(esalq-biography)$
  \input{$esalq-biography$}
  \clearpage
$endif$
$if(esalq-epigraph)$
  \input{$esalq-epigraph$}
  \clearpage
$endif$
