...
\newcommand{\Sobrenome}{Ribeiro Junior}
...
%
\newcommand{\TituloObtido}{%
  Dissertation presented to obtain the degree of Master in Science.
...
\newcommand{\PalavrasChaveFicha}{%
  1. Dados de contagens
  2. Dispersão variável
  3. Inferência baseada em verossimilhança
