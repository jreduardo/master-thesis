...
```{block2, type="main_abstract_en", latex.options='{Contributions to the Analysis of Dispersed Count Data}'}
...
```{block2, type="main_abstract_pt", latex.options='{Contribuições à Análise de Dados de Contagem}'}
