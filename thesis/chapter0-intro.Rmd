...
The standard regression model for the models from the exponential family
(generalized linear models) and for the aforementioned models is linked
to the mean (or expectation-related) parameter. Thereby, the variance of
...
data, his proposal can be extended by using quasi-likelihood estimation
