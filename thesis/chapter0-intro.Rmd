...
data and an efficient Newton scoring algorithm that can be used for
fitting.
...
and overdispersion, respectively.  While using the Poisson regression
...
dependence models [@Winkelmann1995].  Another possible explanation for
underdispersion is when the responses correspond to order statistics of
component observations, such as maxima of Poisson distributed counts
[@Steutel1989].
...
data, his proposal can be extended by using quasi-likelihoods estimation
methods [@Wedderburn1974; @Nelder1987]. For count data, a full
...
COM-Poisson models. An overview and comparison of some flexible
