...
In this paper, we propose the double COM-Poisson models where the mean
and dispersion parameters of the COM-Poisson distribution are modeled in
terms of covariates. These model are quite flexible and allow us to
identify significant effects in both mean and dispersion of the observed
count data.
...
[@Molenberghs2007; @Molenberghs2010; @Molenberghs2017]
