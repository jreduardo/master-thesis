...
suitable, hence the Poisson regression model is inappropriate. In this
work, we review and compare the use of COM-Poisson, Gamma-Count,
generalized Poisson and Poisson-Tweedie models. The application of these
models is illustrated with the analysis of a real count data.
\vspace*{0.3cm}

**Keywords:** COM-Poisson distribution, Gamma-Count distribution,
  Generalized Poisson distribution, Overdispersion, Poisson-Tweedie
  family, Underdispersion.
...
voluptas nulla pariatur? @Bonat2018 Bailler et al. [-@Bailer1994]
[@Consul1992]
